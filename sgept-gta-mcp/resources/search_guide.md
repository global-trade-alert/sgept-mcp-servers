...
## Multi-Pass Workflow & Detail Levels
...
Returns analysis-ready data (sectors, affected countries, all dates, MAST chapter) for exactly the interventions you selected.
